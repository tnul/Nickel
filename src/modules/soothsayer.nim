...
module "🔮", "Шар предсказаний":
  command "шар", "правда":
    usage = "шар <высказывание> - правдиво ли данное высказывание"
    await api.answer(msg, "🎱 " & random(Answers))

module "&#9752;", "Вероятность событий":
  command "вероятность", "инфа":
    usage = "инфа <высказывание> - определяет вероятность чего-то"
    await api.answer(msg, "Вероятность - $1%" % [$(random(100) + 1)])
